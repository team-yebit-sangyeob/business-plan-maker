...
2. canonical_text: 앞선 턴의 주어와 대상, 전제를 되살려 그 문장만 봐도 뜻이 통하는 한국어 한 문장으로 다시 쓴다. 대명사와 지시어, 생략된 주어를 빠짐없이 채운다.
...
맥락 복원의 핵심: [현재 슬롯]과 [최근 대화]를 근거로 대명사와 지시어("그거", "거기", "그쪽"), 생략된 주어·대상을 모두 채운다. 한 발화에 의미 단위가 여럿이면 나누고, 하나뿐이면 1개만 낸다.
